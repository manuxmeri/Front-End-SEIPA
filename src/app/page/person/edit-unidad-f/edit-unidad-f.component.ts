...
import { UnidadEconomicaPA } from 'src/app/interfaces/unidadE';
import { ApiService } from 'src/app/service/api.service';

@Component({
  selector: 'app-edit-unidad-f',
  templateUrl: './edit-unidad-f.component.html',
  styleUrls: ['./edit-unidad-f.component.css']
})
export class EditUnidadFComponent implements OnInit {
  formUnid: FormGroup;
  idUnidad: any;
  oficinas: any[] = [];
  localidades: any[] = [];
